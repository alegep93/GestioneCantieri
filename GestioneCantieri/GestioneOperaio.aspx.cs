...
namespace GestioneCantieri
{
    public partial class GestioneOperaio : System.Web.UI.Page
    {
        ...
        protected void btnInserisci_Click(object sender, EventArgs e)
        {
            ...
            {
                bool isInserito = GestioneOperaioDAO.InserisciOperaio(idCant, acquirente, txtQta.Text, txtPzzoManodop.Text,
                    txtDescrManodop.Text, txtNote1.Text, txtNote2.Text, chkVisibile.Checked, chkRicarico.Checked);
