...
{
    public class GestioneOperaioDAO : BaseDAO
    {
        //SELECT
        ...
        //INSERT
        public static bool InserisciOperaio(string idCant, string operaio, string qta, string tipologia, string pzzoManodop, string descrManodop,
