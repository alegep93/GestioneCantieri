...
{
    public class RientroMaterialeDAO : BaseDAO
    {
        //SELECT
        ...
        public static List<MaterialiCantieri> GetMaterialeCant(string idCant, string codArt, string descrCodArt)
        {
            ...
            {
                throw new Exception("Errore durante l'applicazione dei filtri sui materiali di un cantiere", ex);
            }
            finally { cn.Close(); }
        }
            ...
            string fornitore, string numeroBolla, string protocollo, string note)
        {
            ...
            try
            {
                sql = "INSERT INTO TblMaterialiCantieri (IdTblCantieri,DescriMateriali,Qta,Visibile, " +
                      "Ricalcolo,ricaricoSiNo,Data,PzzoUniCantiere, " +
                      ...
                      "VALUES (@pIdCant,@pDescrMat,@pQta,@pVisibile,@pRicalcolo,@pRicarico,@pData,@pPzzoUnit, " +
                      "@pRientro,@pCodArt,@pDescriCodArt,@pUnitMis, " +
